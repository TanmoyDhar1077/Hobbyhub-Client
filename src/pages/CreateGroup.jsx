    ...
    <div className="pt-[65px] w-11/12 lg:w-10/12 mx-auto">
      <div className="max-w-3xl mx-auto p-6 my-10 bg-red-100 shadow-lg rounded-lg border border-red-200">
        ...
        <form onSubmit={handleAddGroup} className="grid grid-cols-1 gap-4">
          ...
          <select
            name="hobbyCategory"
            className="w-full bg-white border text-red-500  border-red-300 focus:outline-none focus:ring-1 focus:ring-red-300 p-2 rounded-md"
            required
          >
          ...
          <input
            ...
            readOnly
            className="w-full bg-gray-100 border text-red-500 border-red-300 focus:outline-none focus:ring-1 focus:ring-red-300 p-2 rounded-md"
          />
          <input
            type="email"
            name="userEmail"
